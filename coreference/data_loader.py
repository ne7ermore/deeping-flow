...
if __name__ == "__main__":
    ...
    corpus = common.middle_load("corpus")
    ...
    print(tgt_indexs_tensor.shape)
    print(src_tensor.shape)
    print(eos_indexs.shape)
    print(tgt_indexs_tensor.shape)
    print(tgt_max_len)
...
# for (src_tensor, src_postion, turns_tensor), (tgt_tensor, tgt_postion), tgt_indexs_tensor, src_max_len, eos_indexs, tgt_max_len in dl:
